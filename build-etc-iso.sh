...
# Debian Installer Preseed File for Automated Installation
# Generated by EmComm Tools Customizer
# Reference: https://www.debian.org/releases/stable/amd64/apbs02.en.html
#
# IMPORTANT: This preseed is for debian-installer (d-i), the text-based installer.
# Boot with "auto=true priority=critical preseed/file=/cdrom/preseed.cfg" to enable automation.
# In automatic mode, d-i respects all preseed values including partitioning.
...
# Configure network by DHCP (automatic)
...
### Account setup
# Root user (disable, use sudo instead)
...
### Partitioning
# This section will be replaced with strategy-specific directives
...
# Choose software to install (skip popularity-contest)
